...
if($acx_fsmi_purchased_li_array == "" || !is_array($acx_fsmi_purchased_li_array))
{
	...
	class ACX_FSMI_LICENCE_TGM_Plugin_Activation {
		 ...
		 * @var string
		 */
		protected $menu = 'Acurax-Social-Icons-Settings-Install-Addons';
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'Install Addons', 'acx_fsmi_licence_tgmpa' ),
				'menu_title'                      => __( 'Install Addons', 'acx_fsmi_licence_tgmpa' ),
		 ...
		 * http://example.com/wp-admin/themes.php?page=Acurax-Social-Icons-Settings-Install-Addons
		 *
		 * @since 2.5.0
		 *
		 ...
		 *
		 * I.e. depending on the config settings passed something along the lines of:
		 * http://example.com/wp-admin/themes.php?page=Acurax-Social-Icons-Settings-Install-Addons&plugin_status=install
		 *
		 * @since 2.5.0
		 *
