...
?>
	...
	<p>
		...
		<input class="upload_image_button" type="button" value="<?php esc_html_e( 'Upload Image', 'Nexus' ); ?>" data-choose="<?php esc_html_e( 'Choose Header Image', 'Nexus' ); ?>" data-update="<?php esc_html_e( 'Use For Header', 'Nexus' ); ?>" /><br/>
	</p>
<?php
}
endif;
