	...
	array( "name" => "wrap-general",
		...
		array( "type" => "subnavtab-start",),
			...
			array( "name" => "general-3",
				   "type" => "subnav-tab",
				   "desc" => esc_html__("Featured Posts",$themename)),
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Header Section Custom Background",$themename),
				   "id" => $shortname."_featured_bg",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("If you would like to use your own background image for the Header section ( behind the featured section on homepage and category pages ) click the Upload Image button.",$themename)
			),
			...
			array( "name" => "Show Featured Posts on Category pages",
                   "id" => $shortname."_category_featured",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display featured ( sticky ) posts on category pages. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Display 3 Columns on Homepage",$themename),
				   "id" => $shortname."_3rd_column",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => esc_html__("This will enable 3 column layout on homepage.",$themename)
			),
		...
		array( "name" => "general-3",
			...
			array( "name" => esc_html__("Display Featured Posts",$themename),
				   "id" => $shortname."_featured",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => esc_html__("You can choose whether or not to display the Featured Articles section on the homepage. If you don't want to utilize this feature simply disable this option.",$themename)
			),
			...
			array( "name" => esc_html__("Featured Posts Category",$themename),
				   ...
				   "type" => "select",
				   "options" => $site_cats,
				   "desc" => esc_html__("Here you can choose which category to be used to populate the Featured Posts on the homepage.",$themename),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => esc_html__("Enable 728x90 banner in Header",$themename),
				   "id" => $shortname."_header_banner",
					"type" => "checkbox",
				   "std" => "false",
				   "desc" => esc_html__("Enabling this option will display a 728x90 banner ad in the header. If enabled you must fill in the banner image and destination url below.",$themename)
			),
			...
			array( "name" => esc_html__("Enable 970x90 banner in Footer",$themename),
				   "id" => $shortname."_footer_banner",
					"type" => "checkbox",
				   "std" => "false",
				   "desc" => esc_html__("Enabling this option will display a 970x90 banner ad in the footer. If enabled you must fill in the banner image and destination url below.",$themename)
			),

			array( "type" => "clearfix",),

			array( "name" => esc_html__("Input 728x90 header banner image url",$themename),
				   "id" => $shortname."_header_banner_image",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("Here you can provide 728x90 image url for the header banner.",$themename),
					"validation_type" => "url"
			),

			array( "name" => esc_html__("Input 728x90 header banner image description",$themename),
				   "id" => $shortname."_header_banner_description",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("Here you can provide 728x90 header banner description.",$themename),
					"validation_type" => "nohtml"
			),

			array( "name" => esc_html__("Input 728x90 header banner destination url",$themename),
				   "id" => $shortname."_header_banner_url",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("Here you can provide 728x90 image destination url for the header banner.",$themename),
					"validation_type" => "url"
			),

			array( "name" => esc_html__("Input 970x90 footer banner image url",$themename),
				   "id" => $shortname."_footer_banner_image",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("Here you can provide 970x90 image url for the footer banner.",$themename),
					"validation_type" => "url"
			),

			array( "name" => esc_html__("Input 970x90 footer banner image description",$themename),
				   "id" => $shortname."_footer_banner_description",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("Here you can provide 970x90 footer banner description.",$themename),
					"validation_type" => "nohtml"
			),

			array( "name" => esc_html__("Input 970x90 footer banner destination url",$themename),
				   "id" => $shortname."_footer_banner_url",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("Here you can provide 970x90 image destination url for the footer banner.",$themename),
					"validation_type" => "url"
			),
