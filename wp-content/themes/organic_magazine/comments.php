	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use organicthemes_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define organicthemes_comment() and that will be used instead.
				 * See organicthemes_comment() in organicthemes/functions.php for more.
				 */
				wp_list_comments( array( 'callback' => 'organicthemes_comment' ) );
			?>
		</ol>
